...
import { 
  ...
  ActivityIndicator, Image, StatusBar, LayoutAnimation 
} from 'react-native';
...
export default function ChatScreen({ route, navigation }) {
  ...
  useEffect(() => {
    ...
    const ch = subscribeToTable(`chat-${threadId}`, 'chat_messages', `thread_id=eq.${threadId}`, (payload) => {
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerInfo}>
          ...
          <View>
            <Text style={styles.recipientName} numberOfLines={1}>{recipientName || 'Chat'}</Text>
        ...
        <TouchableOpacity style={styles.headerAction} onPress={() => showToast('Feature coming soon', 'info')}>
      ...
      <View style={styles.inputArea}>
        <TouchableOpacity style={styles.attachBtn} onPress={() => showToast('Attachments coming soon', 'info')}>
        ...
        <TouchableOpacity 
          style={[styles.sendBtn, !inputText.trim() && { opacity: 0.5, backgroundColor: T.surfaceHigh }]} 
...
const styles = StyleSheet.create({
  ...
  headerAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: T.bg, alignItems: 'center', justifyContent: 'center', marginRight: 12, borderWidth: 1, borderColor: T.border },
  ...
  headerAction: { width: 40, height: 40, borderRadius: 20, backgroundColor: T.bg, alignItems: 'center', justifyContent: 'center' },
  ...
  myTimeText: { fontSize: 9, marginTop: 4, color: T.bg, opacity: 0.7, alignSelf: 'flex-end', fontWeight: '600' },
  theirTimeText: { fontSize: 9, marginTop: 4, color: T.textSub, alignSelf: 'flex-end', fontWeight: '600' },
