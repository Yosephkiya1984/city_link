...
export const Config = {
  ...
  supaKey:    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF6YnRsc2h0b2V5dGlraXlzbXlyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzM3NjIwNzMsImV4cCI6MjA4OTMzODA3M30.E_BR1IuVfKOdeJeuFTPaKVJjFlrs4zKypJWbTal1-P0',
...
export const FAYDA_DB = {
  '100000000001': { name:'Abebe Bikila',  dob:'1982-05-12', gender:'M', region:'Addis Ababa', status:'ACTIVE' },
  '100000000002': { name:'Tigist Bekele', dob:'1995-03-20', gender:'F', region:'Addis Ababa', status:'ACTIVE' },
  '100000000003': { name:'Dawit Haile',   dob:'1988-11-07', gender:'M', region:'Oromia',      status:'ACTIVE' },
  '100000000004': { name:'Selamawit G.', dob:'1991-07-15', gender:'F', region:'Addis Ababa', status:'ACTIVE' },
  '100000000005': { name:'Yonas Tesfaye',dob:'1975-09-30', gender:'M', region:'Amhara',      status:'SUSPENDED' },
};

// Exchange rates (demo — replace with live API)
export const EXCHANGE_RATES = [
  { code:'USD', name:'US Dollar',     flag:'🇺🇸', buy:56.20, sell:57.10 },
  { code:'EUR', name:'Euro',          flag:'🇪🇺', buy:61.40, sell:62.30 },
  { code:'GBP', name:'British Pound', flag:'🇬🇧', buy:70.80, sell:71.90 },
  { code:'SAR', name:'Saudi Riyal',   flag:'🇸🇦', buy:14.90, sell:15.20 },
  { code:'AED', name:'UAE Dirham',    flag:'🇦🇪', buy:15.20, sell:15.50 },
  { code:'CNY', name:'Chinese Yuan',  flag:'🇨🇳', buy:7.70,  sell:7.95  },
