...
const translations = {
  ...
  'browse_listings_sub': { en: 'Browse amazing products from verified merchants', am: 'ከተረጹዋት ነጋዚዎች የተለያዩ እቃዎችን ይቃኙ', or: 'Madallii warra kan fayyadamu keessaa ilaali' },
  ...
  'city_services_title': { en: 'Addis Ababa City Services', am: 'የአዲስ አበባ አገልግሎቶች', or: 'Tajaajilota Addis Ababa' },
  'credit_score_title': { en: 'Credit Score', am: 'የክሬዲት ነጥብ', or: 'Qabxii Kireeditii' },
  'member': { en: 'Member', am: 'ዜጋ', or: 'Lammi' },
  'build_info': { en: 'CityLink Addis Ababa', am: 'CityLink Addis Ababa', or: 'CityLink Addis Ababa' },
  ...
  'print_qr_desc': { am: 'ከደንበኞች ክፍያ ለመቀበል የእርስዎን ልዩ የሱቅ QR ኮድ ያውርዱ።', or: 'Kaffaltii fudhaachuuf koodii QR keessan buufadhaa.' },
  ...
  'no_rests_sub': { am: 'ነጋዴዎች እስካሁን ምንም አይነት ምግብ ቤት አላስመዘገቡም።', or: 'Daldaltoonni nyaata hin galmeessine.' },
  ...
  'escrow_info': { am: 'እቃው መድረሱን እስኪያረጋግጡ ድረስ ገንዘቡ በታማኝነት (escrow) ይያዛል።', or: 'Kaffaltiin keessan amanamummaan (escrow) qabama.' },
  'msg_soon': { am: 'መልእክት መላላኪያ በቅርቡ ይጀምራል', or: 'Ergaa barreeffamaa dhiyootti' },
  'pin_required_desc': { am: 'ከ %{amt} ETB በላይ ለሆኑ ግዢዎች የእርስዎን PIN ማስገባት ያስፈልጋል።', or: 'Kaffaltii %{amt} ETB olta\'uuf koodii PIN barbaachisaadha.' },
  'escrow_success_title': { am: 'የታማኝነት ክፍያ (Escrow) ጀምሯል', or: 'Kaffaltiin amanamummaa eegaleera' },
  'pin_share_instruction': { am: 'እቃውን ሲረከቡ ይህንን የደህንነት PIN ለሻጩ ይስጡ፡', or: 'Koodii PIN kana kaffaltii xumuruuf daldalaaf kennaa:' },
  'pin_confirm_warning': { am: 'ሻጩ እቃውን መላኩን ካረጋገጠ በኋላ ይህንን PIN ለግምገማ ይጠቀሙበታል።', or: 'Koodii PIN kanaan kaffaltii keessan xumuruu dandeessu.' },
  ...
  'cv_builder_desc': { am: 'የእርስዎን የሙያ መገለጫ እዚህ ይገንቡ። ይህ መረጃ ለሥራ ማመልከቻዎች ጥቅም ላይ ይውላል።', or: 'Piroofayila ogummaa keessan asitti ijaaraa. Kun iyyata hojiitiif ni tajaajila.' },
