...
export default function AppNavigator() {
  ...
  const linking: LinkingOptions<RootStackParamList> = React.useMemo(
    () => ({
  ...
  useEffect(() => {
    if (currentUser) {
      ...
      if (uiMode === 'merchant' || currentUser.role === 'merchant')
        RealtimeService.setupMerchantRealtime();
      if (uiMode === 'agent' || currentUser.role === 'delivery_agent')
        RealtimeService.setupAgentRealtime();
    } else {
  ...
  return (
    <NavigationContainer key={uiMode} linking={linking} theme={navigationTheme}>
      <RootStack.Navigator
        screenOptions={{
          headerShown: false,
      ...
      >
        {!currentUser ? (
          ...
          <>
            ...
            />
            <RootStack.Screen
              name="BecomeDeliveryAgent"
              component={BecomeDeliveryAgentScreen}
            ...
            />
            <RootStack.Screen
              name="FaydaIdentityPortal"
              component={FaydaKycScreen}
        ...
        {__DEV__ && (
          <>
            <RootStack.Screen
              name="Wallet"
              component={require('../screens/core/WalletScreen').default}
            />
            <RootStack.Screen
              name="Parking"
              component={require('../screens/citizen/ParkingScreen').default}
            />
            <RootStack.Screen
              name="Food"
              component={require('../screens/citizen/FoodScreen').default}
            />
            <RootStack.Screen
              name="Delala"
              component={require('../screens/citizen/DelalaScreen').default}
            />
            <RootStack.Screen
              name="Marketplace"
              component={require('../screens/citizen/MarketplaceScreen').default}
            />

            {/* Merchant Dashboards (Direct Access) */}
            <RootStack.Screen
              name="ShopDashboard"
              component={require('../screens/merchant/ShopDashboard').default}
            />
            <RootStack.Screen
              name="RestaurantDashboard"
              component={require('../screens/merchant/RestaurantDashboard').default}
            />
            <RootStack.Screen
              name="DelalaDashboard"
              component={require('../screens/merchant/DelalaDashboard').default}
            />
            <RootStack.Screen
              name="ParkingDashboard"
              component={require('../screens/merchant/ParkingDashboard').default}
            />
            <RootStack.Screen
              name="EkubDashboard"
              component={require('../screens/merchant/EkubDashboard').default}
            />

            {/* 🛠️ Agent & Admin (Direct Access) */}
            <RootStack.Screen
              name="AgentDashboard"
              component={require('../screens/agent/DeliveryAgentDashboard').default}
            />
            <RootStack.Screen
              name="AdminDashboard"
              component={require('../screens/admin/AdminScreen').default}
            />
            <RootStack.Screen
              name="MerchantPortal"
              component={require('../screens/merchant/MerchantPortalScreen').default}
            />
            <RootStack.Screen
              name="BecomeAgent"
              component={require('../screens/agent/BecomeDeliveryAgentScreen').default}
            />
          </>
        )}
      </RootStack.Navigator>
