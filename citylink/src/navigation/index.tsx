...
function TabIcon({ iconName, iconNameActive, label, focused, unread = 0, C }: TabIconProps) {
  ...
  useEffect(() => {
    Animated.parallel([
      Animated.spring(scale, { toValue: focused ? 1.15 : 1, useNativeDriver: true, tension: 150, friction: 10 }),
      Animated.timing(opacity, { toValue: focused ? 1 : 0.6, duration: 250, useNativeDriver: true }),
    ]).start();
  }, [focused]);
  ...
  return (
    <View style={{ alignItems: 'center', gap: 5, width: 60 }}>
      ...
      {focused && (
        <View style={{
          position: 'absolute', top: -14, width: 4, height: 4,
    ...
    >
      <Tab.Screen name="Home" component={HomeScreen}
        options={{ tabBarIcon: ({ focused }) =>
          <TabIcon iconName="home-outline" iconNameActive="home" label="Home" focused={focused} C={C} /> }} />

      <Tab.Screen name="Marketplace" component={MarketplaceScreen}
        options={{ tabBarIcon: ({ focused }) =>
          <TabIcon iconName="grid-outline" iconNameActive="grid" label="Market" focused={focused} C={C} /> }} />

      <Tab.Screen name="Ekub" component={EkubScreen}
        options={{ tabBarIcon: ({ focused }) =>
          <TabIcon iconName="people-outline" iconNameActive="people" label="Ekub" focused={focused} C={C} /> }} />

      <Tab.Screen name="AI" component={AIScreen}
        options={{ tabBarIcon: ({ focused }) =>
          <TabIcon iconName="sparkles-outline" iconNameActive="sparkles" label="AI" focused={focused} C={C} /> }} />

      <Tab.Screen name="Profile" component={ProfileScreen}
        options={{ tabBarIcon: ({ focused }) =>
          <TabIcon iconName="person-outline" iconNameActive="person" label="Me" focused={focused} C={C} /> }} />
    </Tab.Navigator>
  );
}
...
export default function AppNavigator() {
  ...
  console.log('🔧 Navigation - currentUser:', currentUser?.id);
